              ...
              <div className="create__item">
                <form onSubmit={sendFileToIPFS}>
                  ...
                  <div className="form__input">
                    ...
                    <input type='file' className="upload__input" onChange={onSelectFile} />
                  ...
                  <div className="form__input">
                    ...
                    <input type="text" placeholder="Enter title" onChange={onAddTitle} name="title"/>
                  </div>
                  ...
                  <button type='submit' className="btn btn-success">Mint NFT</button>
                </form>
              </div>
            </Col>
          </Row>
